...
# Fungsi cek apakah perintah tersedia
is_installed() {
  command -v "$1" &> /dev/null
}

# Update sistem
echo "[INFO] Melakukan update sistem..."
...
# Jalankan drosera apply
export DROSERA_PRIVATE_KEY=$evm_pk
drosera apply

# Setup Docker Compose untuk node Drosera
